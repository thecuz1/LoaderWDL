...
// Absolute Lua C API addresses recovered by AOB scan (0 = not found; fall back to the offset tables).
...
// AOB signatures for the Lua C API functions, cross-validated against both the dx12 1.6.3 and dx11 builds (unique match in each).
// `??` bytes are wildcards: they cover RIP-relative displacement fields that differ per build.
static const uint8_t sig_luaL_loadbuffer[] = { 0x56, 0x48, 0x83, 0xEC, 0x40, 0x48, 0x8B, 0x05, 0x00, 0x00, 0x00, 0x04, 0x48, 0x31, 0xE0, 0x48, 0x89, 0x44, 0x24, 0x38, 0x48, 0x89, 0x54, 0x24, 0x28, 0x4C, 0x89, 0x44, 0x24, 0x30, 0x48, 0x8D, 0x15, 0x2B, 0x00, 0x00, 0x00, 0x4C, 0x8D, 0x44, 0x24, 0x28, 0xE8, 0xA1, 0x84, 0x00, 0x00, 0x89 };
static const uint8_t mask_luaL_loadbuffer[] = { 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0x00, 0x00, 0x00, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF };
static const uint8_t sig_lua_pcall[] = { 0x56, 0x57, 0x53, 0x48, 0x83, 0xEC, 0x40, 0x44, 0x89, 0xC7, 0x48, 0x89, 0xCE, 0x48, 0x8B, 0x05, 0x00, 0x00, 0x00, 0x04, 0x48, 0x31, 0xE0, 0x48, 0x89, 0x44, 0x24, 0x38, 0x45, 0x85, 0xC9, 0x74, 0x28, 0x7E, 0x31, 0x48, 0x8B, 0x46, 0x18, 0x49, 0x63, 0xC9, 0x48, 0xC1, 0xE1, 0x04, 0x48, 0x01 };
static const uint8_t mask_lua_pcall[] = { 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0x00, 0x00, 0x00, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF };
static const uint8_t sig_lua_tolstring[] = { 0x56, 0x57, 0x53, 0x48, 0x83, 0xEC, 0x20, 0x4C, 0x89, 0xC6, 0x89, 0xD3, 0x48, 0x89, 0xCF, 0x85, 0xD2, 0x7E, 0x45, 0x48, 0x8B, 0x47, 0x18, 0x48, 0x63, 0xCB, 0x48, 0xC1, 0xE1, 0x04, 0x48, 0x01, 0xC8, 0x48, 0x83, 0xC0, 0xF0, 0x48, 0x3B, 0x47, 0x10, 0x48, 0x8D, 0x15, 0x00, 0x00, 0x00, 0x03 };
static const uint8_t mask_lua_tolstring[] = { 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0x00, 0x00, 0x00, 0xFF };
static const uint8_t sig_lua_gettop[] = { 0x8B, 0x44, 0x24, 0x20, 0x44, 0x31, 0xE8, 0x0F, 0xB7, 0x4C, 0x24, 0x24, 0x83, 0xF1, 0x0A, 0x09, 0xC1, 0x0F, 0x84, 0xAC, 0x00, 0x00, 0x00, 0x4C, 0x89, 0xE1, 0xE8, 0x00, 0x00, 0x00, 0x03, 0x48, 0x89, 0xF1, 0x4C, 0x89, 0xE2, 0x49, 0x89, 0xC0, 0x4D, 0x89, 0xF1, 0xE8, 0x90, 0xFD, 0xFF, 0xFF };
static const uint8_t mask_lua_gettop[] = { 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0x00, 0x00, 0x00, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF };
static const uint8_t sig_lua_settop[] = { 0x89, 0xF1, 0x4C, 0x89, 0xE2, 0x49, 0x89, 0xC0, 0x4D, 0x89, 0xF1, 0xE8, 0x90, 0xFD, 0xFF, 0xFF, 0x85, 0xC0, 0x75, 0x14, 0x48, 0x89, 0xF1, 0x31, 0xD2, 0x45, 0x31, 0xC0, 0x45, 0x31, 0xC9, 0xE8, 0xDC, 0x7F, 0x00, 0x00, 0x85, 0xC0, 0x74, 0x3A, 0xB9, 0x02, 0x00, 0x00, 0x00, 0xFF, 0xD7, 0x48 };
static const uint8_t mask_lua_settop[] = { 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF };
...
// dx11 auto-detected; dx12 is the default (OFFSETS_156 -> 1.5.6).
void DetectBuild() {
